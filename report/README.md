...
2. [ ] Картинка на таймаут и Circuit Breaker.
3. [ ] Картинка как gRPC ложится на HTTP/2.
4. [ ] Рассказать про JSON RPC: выглядит вот так, получается странно.
5. [ ] CURL / HTTPie просто screenshot.
6. [ ] Видосик про grpcurl / evans.
7. [ ] Говорить только Protobuf!
8. [ ] Показать как удалить поле и добавить новое поле в gRPC протокол.
9. [ ] Трассировка TraceId/ SpanId в заголовках.
10. [ ] Продумать проблематику в начале доклада.
11. [ ] Сократит план доклада (сравниваем по основным пунктам).
12. [ ] gRPC на 6 слайде маленькими буквами.
13. [ ] На REST два метода, в gRPC схлопнули в одно.
14. [ ] Объяснить почему зачем мы хотим использовать gRPC из браузера? На мобильных устройствах работает gRPC (мем c
    Тинькофф: работает и ладно).
15. [ ] Показать как происходит отмена запроса в gRPC: RST_STREAM в HTTP/2.
16. [ ] Объяснить почему вам нужно выбрать gRPC.
17. [ ] Добавить минусы gRPC: версионирование, в Service Mesh сложно влезть внутрь запроса и модифицировать.
18. [ ] Добавить голосование кто выиграл.
19. [ ] Перенести первые выводы до слайда "Архитектурные Паттерны".
